...
project = 'molecool'
copyright = ("2020, Madison Berger. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A Python package for analyzing and visualizing xyz files. For MMFSF bootcamp.',
     'Miscellaneous'),
]
